...
write.table(subject.info, "outx02_subject_info.txt", row.names=F)
...
write.table(fsl.vbm, "outx02_fsl_vbm.txt", row.names=F)
...
write.table(spm.vbm, "outx02_spm_vbm.txt", row.names=F)
...
write.table(alff, "outx02_alff.txt", row.names=F)
...
write.table(falff, "outx02_falff.txt", row.names=F)
...
write.table(reho, "outx02_reho.txt", row.names=F)
...
write.table(label.fa, "outx02_label_fa.txt", row.names=F)
...
write.table(label.md, "outx02_label_md.txt", row.names=F)
...
write.table(tract.fa, "outx02_tract_fa.txt", row.names=F)
...
write.table(tract.md, "outx02_tract_md.txt", row.names=F)
