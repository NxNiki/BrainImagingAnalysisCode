...
write.table(spm.vbm, "outd01_spmvbm_features.txt", row.names=F)
...
#label.fa = read.xls("Result04_DTI_PANDA/AllAtlasResults/WMlabelResults_FA.xls")
label.fa = read.csv(file="Result04_DTI_PANDA/AllAtlasResults/WMlabelResults_FA.csv", sep=",")
...
# ------------------------------- label.md --------------------------------
#label.md = read.xlsx(file="Result04_DTI_PANDA/AllAtlasResults/WMlabelResults_MD.xls", sheetIndex=1, header=TRUE)
#label.md = read.table(file="Result04_DTI_PANDA/AllAtlasResults/WMlabelResults_MD.csv", header=T, sep=",")
label.md = read.csv(file="Result04_DTI_PANDA/AllAtlasResults/WMlabelResults_MD.csv", sep=",")
...
#tract.fa = read.xlsx(file="Result04_DTI_PANDA/AllAtlasResults/WMtractResults_FA.xls", sheetIndex=1, header=TRUE)
tract.fa = read.csv(file="Result04_DTI_PANDA/AllAtlasResults/WMtractResults_FA.csv", sep = ",")
...
#tract.md = read.xlsx(file="Result04_DTI_PANDA/AllAtlasResults/WMtractResults_MD.xls", sheetIndex=1, header=TRUE)
tract.md = read.csv(file="Result04_DTI_PANDA/AllAtlasResults/WMtractResults_MD.csv", sep = ",")
